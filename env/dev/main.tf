...
module "lvm" {
  depends_on = [module.rg, module.nics, module.pips, module.nsg, module.kv, module.kvs]
...
module "wvm" {
  depends_on = [module.rg, module.nics, module.pips, module.nsg, module.kv, module.kvs, module.association, module.lvm]
...
module "sqldb" {
  ...
  source        = "../../modules/azurerm_sql_server_sql_db/azurerm_mssql_db"
...
module "aks_acr_assign" {
  ...
  source                   = "../../modules/azurerm_role_assignment_aks_attach_to_acr"
...
module "lb" {
  depends_on     = [module.rg, module.pips, module.subnet, module.vnet]
  source         = "../../modules/azurerm_loadbalancer/azurerm_lb"
...
module "lb_bpool" {
  ...
  source        = "../../modules/azurerm_loadbalancer/azurerm_lb_backend_address_pool"
...
module "lb_hprobe" {
  depends_on = [module.rg, module.pips, module.subnet, module.vnet, module.lb]
  source     = "../../modules/azurerm_loadbalancer/azurerm_lb_probe"
...
module "lb_rule" {
  ...
  source     = "../../modules/azurerm_loadbalancer/azurerm_lb_rule"
